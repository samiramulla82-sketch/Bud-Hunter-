...
// Extend Window interface for custom storage API
declare global {
  interface Window {
    storage?: {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewReview({...newReview, type: e.target.value as 'indica' | 'sativa' | 'hybrid'})}
                  className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500"
                >
